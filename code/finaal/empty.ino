...
#define motor1PWM1 19
#define motor1PWM2 18
#define motor2PWM1 21
#define motor2PWM2 12
...
void setup() 
{
    ...
    if (!BTSerial.begin("Youngg_car")) {  // Initialiseer Bluetooth
...
void loop() {
    ...
    digitalWrite(My_Led_Pin, programEnabled);
